class Tutorial extends Phaser.Scene {
    ...
    create() {
        ...
        this.cue = this.add.bitmapText(25, 25, 'gem', 'H to skip', 24, 1).setOrigin(0,0.5)
        ...
        this.time.delayedCall(750, () => {
            ...
            this.tutorial.once('animationcomplete', () => {
                ...
                this.time.delayedCall(500, () => {
                    ...
                    this.time.delayedCall(500, () => {
                        ...
                        this.tutorial.play('boss-tut')
                        this.tutorial.once('animationcomplete', () => {

                            this.time.delayedCall(500, () => {
                                this.tutorial.alpha = 0
                                this.tutorial = this.add.bitmapText(width/2, 35, 'upheaval', 'only the hero\'s health\nwill be visible', 28, 1).setOrigin(0.5,0)

                                this.time.delayedCall(2000, () => {
                                    this.tutorial.text += '\n\n defeat the other player\nto win!'

                                    this.time.delayedCall(2000, () => {
                                        this.countdown = this.add.bitmapText(width/2, (height/2)+72, 'upheaval', '3', 120, 1).setOrigin(0.5)
